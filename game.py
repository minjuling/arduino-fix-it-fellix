...
class Game():
    ...
    def __init__(self):
        ...
        #Image in stage list correspoding to self.stagecheck
    ...
    def ending(self,berry, ras, draw, image, disp):
        ...
        #moving strawberry to raspberry
        berry_x = 10
        for i in range(0,4):
            image.paste(self.image, (0,0))
            image.paste(ras.ras2, (80,10),ras.ras2)
